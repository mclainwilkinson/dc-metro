...
config = {
	...
	# Metro Station Code
	'metro_station_code': 'E05',

	# Bus Stop Code
	'bus_stop_code': '1002406',

	# API Key for WMATA
	'metro_api_key': 'your-wmata-api-token',
	...
	'metro_bus_url': 'https://api.wmata.com/NextBusService.svc/json/jPredictions?StopID=',
	'metro_api_retries': 2,
